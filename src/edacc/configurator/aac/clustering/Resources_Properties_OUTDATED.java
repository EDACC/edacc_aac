 ...
 * @author mugrauer
 */
public class Resources_Properties_OUTDATED extends ClusteringResources{
    ...
    public Resources_Properties_OUTDATED(API api, Parameters params, ClusterHandler handler) throws Exception{
